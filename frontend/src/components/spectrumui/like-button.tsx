  ...
  return (
    <motion.button
      ...
      className={cn(
        ...
        liked
          ? "border-rose-200 bg-rose-50 text-rose-600 hover:border-rose-300 hover:bg-rose-100/70 active:bg-rose-100"
          : "border-slate-200 bg-white text-slate-500 hover:border-rose-200 hover:bg-rose-50/60 hover:text-rose-500 active:bg-rose-50",
        sizeClasses,
        className,
      )}
    >
        ...
        {burst !== null && !shouldReduceMotion && (
          ...
          >
            ...
            {Array.from({ length: PARTICLE_COUNT }).map((_, index) => {
              const angle =
                (index / PARTICLE_COUNT) * Math.PI * 2 - Math.PI / 2;
      ...
      {displayCount !== undefined && showCount && (
        <span
          className="relative inline-flex justify-center overflow-hidden text-slate-600 tabular-nums"

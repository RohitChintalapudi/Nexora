/*
 * @haddybhaiya · OpenShaders
 * https://openshaders.com/@haddybhaiya
 * WebGPU · React component (TypeScript)
 */
...
const HUE: f32 = 0.0823732838;
const HUE_SPREAD: f32 = -0.458619088;
const HUE_TRAVEL: f32 = 1.94238782;
const CHROMA: f32 = 0.117260069;
const LIGHTNESS: f32 = 0.506931067;
const COLOUR_CYCLE: f32 = 0.14711298;
const THETA: f32 = 2.12516117;
const SHEAR: f32 = 0.969389617;
const SHRINK: f32 = 0.958558202;
const LAYERS: f32 = 73.0;
const WARP_FREQ_X: f32 = 0.370834798;
const WARP_FREQ_Y: f32 = 2.36565208;
const WARP_AMP_X: f32 = 0.108738415;
const WARP_AMP_Y: f32 = 0.0220685937;
const ASPECT_X: f32 = 1.69258046;
const ASPECT_Y: f32 = 0.189476639;
const OFFSET_X: f32 = 0.374192178;
const OFFSET_Y: f32 = 0.00186978327;
const TILT: f32 = 0.554939151;
const ZOOM: f32 = 0.900224268;
const CENTRE_X: f32 = 0.332990974;
const CENTRE_Y: f32 = 0.478291154;
const GLOW_SIZE: f32 = 0.00321202073;
const FALLOFF: f32 = 0.258913457;
const VIGNETTE: f32 = 0.121478215;
const FLOW_SPEED: f32 = 0.494852126;
const FLOW_DIRECTION: f32 = -1.0;
const BREATH_RATE: f32 = 0.530921817;
const BREATH_AMOUNT: f32 = 0.0502804928;
const PHASE: f32 = 68.9753876;
const ECHO: f32 = 0.0;
const ECHO_SHIFT: f32 = 0.120228946;
const SOFTNESS: f32 = 0.00256043044;
const LIGHT_SWING: f32 = 0.17669031;
...
export type HaddybhaiyaShaderProps = {
  theme?: ShaderTheme;
  background?: { dark?: string; light?: string };
  time?: number;
  onError?: (error: Error) => void;
...
export function HaddybhaiyaShader({ theme = "dark", background, time, onError, className, style }: HaddybhaiyaShaderProps) {

...
export const Navbar: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`pointer-events-auto relative flex items-center justify-between gap-4 sm:gap-8 px-5 sm:px-7 py-3 sm:py-3.5 min-h-[58px] sm:min-h-[64px] rounded-full bg-[#000000] border border-white/[0.16] shadow-[0_16px_50px_rgba(0,0,0,0.85),_inset_0_1px_1px_rgba(255,255,255,0.22)] backdrop-blur-2xl transition-all duration-300 will-change-transform ${
          scrolled ? 'scale-[0.98] shadow-[0_20px_60px_rgba(0,0,0,0.92)]' : ''
        }`}
      >
        {/* Left: Brand Logo */}

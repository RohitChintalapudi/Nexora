          ...
          {({ isPresent, gate }) => (
            <>
              <motion.button
                ...
                className={cn(
                  "pointer-events-auto fixed inset-0 z-[100] h-full w-full cursor-default bg-slate-950/40 backdrop-blur-sm",
                  backdropClassName,
                )}
              />

              {/* Never takes pointer events, so it carries `inert` alone. */}
              <div
                inert={!isPresent}
              ...
              >
                ...
                <div className="flex w-full flex-col items-center py-8">
                  <motion.div
                    ...
                    className={cn(
                      "pointer-events-auto relative w-full max-w-[26rem] origin-center overflow-hidden rounded-[30px] border border-slate-200 bg-white text-slate-900 will-change-[clip-path]",
                      className,
                    )}
                  >
                    {children}
                    ...
                    {showCloseButton ? (
                      <motion.button
                        ...
                        className="absolute right-4 top-4 inline-flex h-8 w-8 items-center justify-center rounded-full bg-slate-100 text-slate-500 transition-colors hover:bg-slate-200 hover:text-slate-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
                      >

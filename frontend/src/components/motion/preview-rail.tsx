...
function DefaultPreview({ item }: { item: PreviewRailItem }) {
  return (
    <div
      ...
      className="rounded-2xl border border-slate-200 bg-white p-4 shadow-xl shadow-slate-900/10"
    >
      <p
      ...
      >
        {items.map((item, index) => {
            ...
            <>
              <motion.span
                ...
                className={cn(
                  ...
                  highlighted ? "text-slate-900" : undefined,
                )}
              />
            </>
          );
          ...
          const sharedClassName = cn(
            "relative flex text-slate-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500",
            isHorizontal
        ...
        <div
          ...
          className={cn(
            ...
            isHorizontal
              ...
              : previewSide === "before"
                ? "inset-y-0 right-16 left-1 content-center"
                : "inset-y-0 right-1 left-16 content-center",
            previewContainerClassName,
          )}
        >
          {items.map((item) => (
